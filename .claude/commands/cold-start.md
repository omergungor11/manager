...
2. `_docs/MEMORY.md` oku — kalici hafiza, teknik kararlar, ogrenilen pattern'ler
3. `_tasks/task-index.md` oku — dashboard + tum task durumlari
4. `_tasks/active/session-notes.md` oku — onceki session notlari
